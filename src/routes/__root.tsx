...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Widely — API-first link in bio" },
      { name: "description", content: "A premium link-in-bio platform with a real REST API. Manage your links programmatically." },
      { property: "og:title", content: "Widely — API-first link in bio" },
      { property: "og:description", content: "A premium link-in-bio platform with a real REST API." },
